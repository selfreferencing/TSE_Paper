...
**Current source:** [`TSE_seven_laws_v4.tex`](TSE_seven_laws_v4.tex) (`sha256 3dae7aab37cf3d81e91e014ab3550c9b413f188928295b91a1f5f384c90ab48e`), compiled as [`TSE_seven_laws_v4.pdf`](TSE_seven_laws_v4.pdf) — 170 pages, clean build, no undefined references. The prior `v3.8` and `v3.9` files are kept for reference; see [`V4_CHANGES.md`](V4_CHANGES.md) for what changed and why. Published preprint: [arXiv:2512.07901](https://arxiv.org/abs/2512.07901).

**All seven laws are machine-verified in Lean 4 / Mathlib** — 240 theorems in the elaborated environment, 141 of them audited headline results, cold-compiling with zero custom axioms — at [`selfreferencing/TSE_Formal`](https://github.com/selfreferencing/TSE_Formal). Several classical results are carried as explicit hypotheses rather than proven; the paper's Section 29 lists them per law. Version 4 corrects the theorem count (the earlier figure of 73 was the length of an audit list, never a theorem count), sweeps 21 stale module references, and restates Law 7: the printed bifurcation locus is refuted, the first Lyapunov coefficient is recomputed from the vector field as ℓ₁ = −6μ on the locus κ_c(μ) = −6μ, and **the earlier identification of that locus with the γ = 1 boundary is withdrawn as unsupported** — it is recorded as an open conjecture, not a result. See [`V4_CHANGES.md`](V4_CHANGES.md).
